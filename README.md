...
- **状态反馈**：直观显示当前代理状态
- **更新历史**：提供详细的版本更新记录
- **最小权限需求**：仅请求必要的权限（proxy、storage、tabs）
...
2. **切换代理**：在弹出窗口中点击想要使用的代理配置（切换后当前页面会自动刷新）
...
1. **如何快速切换代理？**  
   点击扩展图标，然后点击想要使用的代理配置即可。切换后当前页面会自动刷新以应用新的代理设置。
